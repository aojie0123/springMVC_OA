...
<%@ page import="com.joker.oa.global.Contant" %>
                        ...
                        <tr class="message-unread">
                            <td class="hidden-xs">
                                <label class="option block mn">
                                    <input type="checkbox" name="listId[]" value="${cv.id}">
                            ...
                            <td>
                                ...
                                <c:if test="${cv.status == Contant.CLAIMVOUCHER_SUBMIT || cv.status == Contant.CLAIMVOUCHER_RECHECK}">
                                    <a href="/claim_voucher/to_update?id=${cv.id}">审核</a>
                                </c:if>
                                <c:if test="${cv.status == Contant.CLAIMVOUCHER_APPROVED}">
                                    <a href="/claim_voucher/to_update?id=${cv.id}">打款</a>
                                </c:if>
