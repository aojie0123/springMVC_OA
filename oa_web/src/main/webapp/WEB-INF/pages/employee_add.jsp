    ...
    <div class="tray tray-center">
        ...
        <div class="admin-form theme-primary mw1000 center-block" style="padding-bottom: 175px;">
            <div class="panel heading-border">
                <form:form id="admin-form" modelAttribute="employee" name="addForm" action="/employee/add">
                        ...
                        <div class="section row">
                                ...
                                <label for="sn" class="field select">
                                    <form:select path="departmentSn" cssClass="gui-input" placeholder="所属部门...">
                                        <c:forEach items="${dList}" var="department">
                                            <form:option value="${department.sn}">${department.name}</form:option>
                                        </c:forEach>
                                    </form:select>
                            ...
                            <div class="col-md-6">
                                <label for="post" class="field select">
                                    <form:select path="post" cssClass="gui-input" placeholder="职务...">
